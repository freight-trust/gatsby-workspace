...
description: Quick start guide for getting acclimated with freight-trust-gatsby-workspace
---
...
Lets check out the structure of our project
    ...
    ├── src
    │   ├── data
    │   ├── freight-trust-gatsby-workspace
    │   ├── images
    │   └── pages
    └── yarn.lock
...
1.  **`/src`**: This directory will contain all of the code related to what you
    ...
    - **freight-trust-gatsby-workspace** this is where you’ll override (known as shadowing)
      the default `freight-trust-gatsby-workspace` components
...
1.  **`gatsby-config.js`**: This is the main configuration file for a Gatsby
    ...
    configuration for the site is coming from `freight-trust-gatsby-workspace`
