...
description: Quick start guide for getting acclimated with @fr8/gatsby-workspace
---
...
1.  **`/src`**: This directory will contain all of the code related to what you
    ...
    - **@fr8/gatsby-workspace** this is where you’ll override (known as shadowing)
      the default `@fr8/gatsby-workspace` components
...
1.  **`gatsby-config.js`**: This is the main configuration file for a Gatsby
    ...
    configuration for the site is coming from `@fr8/gatsby-workspace`
