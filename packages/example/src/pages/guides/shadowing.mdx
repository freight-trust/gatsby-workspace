...
1. Open a
   ...
   in the @fr8/gatsby-workspace repo to make sure we’re not working on your
   change.
...
in the `src/@fr8/gatsby-workspace` in your project. The file should have the same
...
1. Create a file at the same directory as the component you wish to shadow.
   Everything after `src/@fr8/gatsby-workspace/` refers to the
   [src directory of @fr8/gatsby-workspace](https://github.com/freight-trust/gatsby-workspace/tree/main/packages/@fr8/gatsby-workspace/src).
...
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| ResourceLinks | [`src/@fr8/gatsby-workspace/components/LeftNav/ResourceLinks.js`](https://github.com/freight-trust/gatsby-workspace/blob/main/packages/example/src/@fr8/gatsby-workspace/components/LeftNav/ResourceLinks.js) | The bottom links on the SideNav, pass `shouldOpenNewTabs` to open links externally |
| Footer        | [`src/@fr8/gatsby-workspace/components/Footer.js`](https://github.com/freight-trust/gatsby-workspace/blob/main/packages/example/src/@fr8/gatsby-workspace/components/Footer.js)                               | The links and content at the bottom of each page                                   |
| Header        | [`src/@fr8/gatsby-workspace/components/Header.js`](https://github.com/freight-trust/gatsby-workspace/blob/main/packages/example/src/@fr8/gatsby-workspace/components/Header.js)                               | The text in the top left corner of the UI Shell                                    |
