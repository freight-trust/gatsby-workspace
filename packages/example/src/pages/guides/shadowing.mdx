...
1. Open a
   [quick issue](https://github.com/freight-trust/gatsby-workspace/issues/new)
   in the freight-trust-gatsby-workspace repo to make sure we’re not working on your
   change.
...
in the `src/freight-trust-gatsby-workspace` in your project. The file should have the same
...
1. Create a file at the same directory as the component you wish to shadow.
   Everything after `src/freight-trust-gatsby-workspace/` refers to the
   [src directory of freight-trust-gatsby-workspace](https://github.com/freight-trust/gatsby-workspace/tree/main/packages/freight-trust-gatsby-workspace/src).
...
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| ResourceLinks | [`src/freight-trust-gatsby-workspace/components/LeftNav/ResourceLinks.js`](https://github.com/freight-trust/gatsby-workspace/blob/main/packages/example/src/freight-trust-gatsby-workspace/components/LeftNav/ResourceLinks.js) | The bottom links on the SideNav, pass `shouldOpenNewTabs` to open links externally |
| Footer        | [`src/freight-trust-gatsby-workspace/components/Footer.js`](https://github.com/freight-trust/gatsby-workspace/blob/main/packages/example/src/freight-trust-gatsby-workspace/components/Footer.js)                               | The links and content at the bottom of each page                                   |
| Header        | [`src/freight-trust-gatsby-workspace/components/Header.js`](https://github.com/freight-trust/gatsby-workspace/blob/main/packages/example/src/freight-trust-gatsby-workspace/components/Header.js)                               | The text in the top left corner of the UI Shell                                    |
