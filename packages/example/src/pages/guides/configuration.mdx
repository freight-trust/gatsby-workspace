...
[`gatsby-config.js`](https://github.com/freight-trust/gatsby-workspace/blob/main/packages/freight-trust-gatsby-workspace/gatsby-config.js)
file.
...
module.exports = {
  ...
  plugins: ['freight-trust-gatsby-workspace'],
};
```
  ...
  plugins: [
    {
      ...
      options: {
        repository: {
          baseUrl: 'https://github.com/freight-trust/gatsby-workspace',
