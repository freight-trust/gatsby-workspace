...
```mdx path=components/GifPlayer/GifPlayer.js src= https://github.com/freight-trust/gatsby-workspace/tree/main/packages/freight-trust-gatsby-workspace/src/components/GifPlayer
<Column colLg='4'>
<GifPlayer>
