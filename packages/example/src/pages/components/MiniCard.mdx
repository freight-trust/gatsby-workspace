...
```mdx path=components/MiniCard/MiniCard.js src=https://github.com/freight-trust/gatsby-workspace/tree/main/packages/@fr8/gatsby-workspace/src/components/MiniCard
<CardGroup>
  <MiniCard title="26 characters per MiniCard" href="/demo">
    ![Github icon](/images/github-icon.png)
  </MiniCard>
