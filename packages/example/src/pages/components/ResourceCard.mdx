...
<Column colMd={4} colLg={4} noGutterSm>
    <ResourceCard
      ...
      href="https://freight-trust-gatsby-workspace.now.sh"
      >
...
```mdx path=components/ResourceCard/ResourceCard.js src=https://github.com/freight-trust/gatsby-workspace/tree/main/packages/freight-trust-gatsby-workspace/src/components/ResourceCard
<Row className="resource-card-group">
  <Column colMd={4} colLg={4} noGutterSm>
    <ResourceCard
