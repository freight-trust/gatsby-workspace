...
```mdx path=components/Aside/Aside.js src=https://github.com/freight-trust/gatsby-workspace/tree/main/packages/freight-trust-gatsby-workspace/src/components/Aside
<Column colMd={2} colLg={3} offsetMd={1} offsetLg={1}>
  <Aside>
