...
```mdx path=components/MediumPosts/MediumPosts.js src=https://github.com/freight-trust/gatsby-workspace/tree/main/packages/freight-trust-gatsby-workspace/src/components/MediumPosts
<MediumPosts color="dark" postLimit={3} />
```
