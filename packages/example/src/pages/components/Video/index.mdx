...
```mdx path=components/Video/Video.js src=https://github.com/freight-trust/gatsby-workspace/tree/main/packages/freight-trust-gatsby-workspace/src/components/Video
...
```mdx path=components/Video.mdx src=https://github.com/freight-trust/gatsby-workspace/blob/main/packages/example/src/pages/components/Video/index.mdx
import localVideo from './local-video.mp4';
import localPoster from './local-poster.jpg';
