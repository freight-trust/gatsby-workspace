...
```mdx path=components/DoDontExample/DoDontExample.js src=https://github.com/freight-trust/gatsby-workspace/tree/main/packages/freight-trust-gatsby-workspace/src/components/DoDontExample
<DoDontExample type="do" captionTitle="Caption title" caption="Caption">
...
| aspectRatio  | string   |          |         | set to `1:1` to force square example <br/>_(We welcome [contributions](https://github.com/freight-trust/gatsby-workspace/tree/main/packages/freight-trust-gatsby-workspace/src/components/DoDontExample) to add additional aspect ratio options)_ |
