...
```mdx path=components/InlineNotification/InlineNotification.js src=https://github.com/freight-trust/gatsby-workspace/tree/main/packages/freight-trust-gatsby-workspace/src/components/InlineNotification
// Info
