...
```mdx path=components/Caption/Caption.js src= https://github.com/freight-trust/gatsby-workspace/tree/main/packages/freight-trust-gatsby-workspace/src/components/Caption
<Caption>
  This is a regular caption. It will attempt to respond to it’s container
  element appropriately.
</Caption>
