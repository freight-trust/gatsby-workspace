...
```mdx path=components/AnchorLinks/AnchorLinks.js src=https://github.com/freight-trust/gatsby-workspace/tree/main/packages/@fr8/gatsby-workspace/src/components/AnchorLinks
<AnchorLinks>
  <AnchorLink>Link 1</AnchorLink>
  <AnchorLink>Link 2</AnchorLink>
  <AnchorLink>Link 3</AnchorLink>
