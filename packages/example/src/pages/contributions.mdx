...
1. Go to
   [@fr8/gatsby-workspace](https://github.com/freight-trust/gatsby-workspace)
...
This project has two packages: the actual theme package (`@fr8/gatsby-workspace`)
...
[website](https://@fr8/gatsby-workspace.now.sh); it’s deployed on every merge to
main.
