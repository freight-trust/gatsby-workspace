...
1. Go to
   [freight-trust-gatsby-workspace](https://github.com/freight-trust/gatsby-workspace)
...
This project has two packages: the actual theme package (`freight-trust-gatsby-workspace`)
...
[website](https://freight-trust-gatsby-workspace.now.sh); it’s deployed on every merge to
main.
...
4. In the project’s
   [release tab](https://github.com/freight-trust/gatsby-workspace/releases),
